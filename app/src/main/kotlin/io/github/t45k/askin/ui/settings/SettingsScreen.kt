    ...
    Column(
        ...
        Card(
            ...
            Column(
                ...
                Text("日次合計回数をローカルに保存するMVPです", color = MaterialTheme.colorScheme.onSurfaceVariant)
                Text("X連携はAndroid共有シートから行います", color = MaterialTheme.colorScheme.onSurfaceVariant)
            }
        }
    }
}
